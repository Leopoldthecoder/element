  ...
  <div
    ...
    <div
      ...
      <transition name="carousel-arrow-left">
        <button
          ...
          @click="debouncedArrowClick(activeIndex - 1)"
    ...
    <ul
      ...
      <li
        ...
        @mouseenter="debouncedIndicatorHover(index)"
...
export default {
  ...
  created() {
    this.debouncedArrowClick = throttle(300, true, index => {
      this.setActiveIndex(index);
    });
    this.debouncedIndicatorHover = throttle(300, index => {
